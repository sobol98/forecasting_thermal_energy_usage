...
x = merged_df['Średnia_godzinowa']
y = merged_df['cieplo_diff']
...
plt.title("Agregacja godzinowa: Zużycie ciepła vs Średnia temperatura")
plt.xlabel("Średnia temperatura godzinowa (°C)")
